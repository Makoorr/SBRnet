...
if(empty($e)){
    ...
    $total_pages_sql = "SELECT COUNT(*) FROM produits where disponibilite=1 and categorie='bouchor';";
    ...
    if($pageno<1 || $pageno>$total_pages)
        header("location:./prod/bouchor.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body onload="updatecookie()">
    <header id="header" class="fixed-top">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
            ...
            <!-- <li><a href="prod/bouchor.php">Produits</a></li> -->
    ...
    <div class="container py-5" style="margin-top: 5em;">
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-md">
                        <h4 style="text-align: center;">
                            <?php
                            $sql="SELECT nom_categorie FROM produits where categorie='bouchor'";
                            $produits = $db->query($sql);
                            foreach($produits as $prod){
                                $nomcateg=$prod[0];
                            }
                ...
                <div class="row">
                    <?php
                        $sql="SELECT * FROM produits where disponibilite=1 and categorie='bouchor' LIMIT $offset, $no_of_records_per_page;";
                        $produits = $db->query($sql);
